...
$data   = ['name' => '', 'email' => '', 'roll_number' => '', 'class' => '', 'teacher' => ''];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors['roll_number'])) {
        $chk = $pdo->prepare("SELECT id FROM students WHERE roll_number = ?");
        $chk->execute([$data['roll_number']]);
...
<body>
    ...
    <div class="form-wrapper">
        <div class="form-card">
            <h2 class="form-title">Add <span>Student</span></h2>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="roll_number"
                                ...
                                value="<?= htmlspecialchars($data['roll_number']) ?>">
                        </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="class"
                                ...
                                placeholder="e.g. Grade 10 / BS-CS"
                    ...
                    <div class="col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="teacher"
                                ...
                                value="<?= htmlspecialchars($data['teacher']) ?>">
                        </div>
